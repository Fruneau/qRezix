...
///D�inition de la version de qRezix
/** La version est g��� automatiquement gr�e aux informations fournies
...
///Chargement de qRezix et de ses diff�ents modules
	...
	:QApplication(argc, argv)
{
	...
	//Lancement de l'interface r�eau
 ...
 * 	- par extension du pr��ent, les interfaces r�eaux client
 *
...
bool RzxApplication::loadCore()
{
	...
	//Initialisation de l'objet repr�entant localhost
	RzxComputer::localhost();

	//V�ification du remplissage des propri��
	...
	//Chargement de la base r�eau de qRezix
 ...
 * �re d�activable par suppression tout bonnement de son chargement
 * qui doit se r�umer �1 ligne...
 * Des connexions sont envisageables entre les modules ou plut� entre
 * cat�ories de modules...
 */
...
///Cr�tion des liens entre les modules
/** L'application principale n�essite que les modules aient
 * plusieurs cat�ories, en particulier pour la trayicon,
 * fen�re principale...
 */
void RzxApplication::linkModules()
{
	//Installation des int�actions entre les modules
	if(properties)
...
///Sauvegarde des donn�s au moment de la fermeture
/** Lance la sauvegarde des donn�s principales lors de la fermeture de rezix.
 * Cette m�hode est cens� permettre l'enregistrement des donn�s lors de la
...
///Retourne un pointeur vers la fen�re principale
/** L'int�� de cette fonction est de fournir un moyen simple
 * de conna�re la fen�re principale pour avoir par un parent...
 */
...
///Retourne la liste des modules charg�
